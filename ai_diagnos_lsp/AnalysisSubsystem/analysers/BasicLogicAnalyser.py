...
from ai_diagnos_lsp.AnalysisSubsystem.analysers.chains.LLM.BasicOmniproviderLLM import OpenrouterLlmFactory
...
def BasicLogicAnalyserWorker(document: TextDocument | Path, ls: AIDiagnosLSP):
    ...
    try:
        ...
        chain = prompt | llm | GeneralDiagnosticsOutputParserFactory()
